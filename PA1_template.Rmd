...
```
Mean total number of steps is equal to `r spd_mean`, median - `r spd_median`.

## What is the average daily activity pattern?
Average number of steps through the day.
```{r daily_activity, echo=T}
...
The distribution changed a bit. There are more days with average number of steps now. Mean is the same - `r spd1_mean`, median value moved to the mean - `r spd1_median`.
